...
##g2
set_property PACKAGE_PIN J19 [get_ports {BC1_SEL[1] }  ]
set_property PACKAGE_PIN G20 [get_ports {BC1_CLK[1] }  ]
set_property PACKAGE_PIN C20 [get_ports {BC1_DATA[4]}  ]
set_property PACKAGE_PIN M17 [get_ports {BC1_DATA[5]}  ]
set_property PACKAGE_PIN B19 [get_ports {BC1_DATA[6]}  ]
set_property PACKAGE_PIN M20 [get_ports {BC1_DATA[7]}  ]
set_property PACKAGE_PIN A20 [get_ports {BC1_LD[1]  }  ]
set_property PACKAGE_PIN K19 [get_ports {BC1_TRT[1] }  ]
set_property PACKAGE_PIN B20 [get_ports {BC1_TRR[1] }  ]
##g3
set_property PACKAGE_PIN W15 [get_ports {BC1_SEL[2] }  ]
set_property PACKAGE_PIN U20 [get_ports {BC1_CLK[2] }  ]
set_property PACKAGE_PIN T16 [get_ports {BC1_DATA[8]}  ]
set_property PACKAGE_PIN U17 [get_ports {BC1_DATA[9]}  ]
set_property PACKAGE_PIN U19 [get_ports {BC1_DATA[10]} ]
set_property PACKAGE_PIN T20 [get_ports {BC1_DATA[11]} ]
set_property PACKAGE_PIN W20 [get_ports {BC1_LD[2]  }  ]
set_property PACKAGE_PIN P20 [get_ports {BC1_TRT[2] }  ]
set_property PACKAGE_PIN N20 [get_ports {BC1_TRR[2] }  ]
##g3
...
##---bc2----##
##g1
set_property PACKAGE_PIN Y8  [get_ports {BC2_SEL[0] }  ]
set_property PACKAGE_PIN W6  [get_ports {BC2_CLK[0] }  ]
set_property PACKAGE_PIN V8  [get_ports {BC2_DATA[0]}  ]
set_property PACKAGE_PIN Y12 [get_ports {BC2_DATA[1]}  ]
set_property PACKAGE_PIN W8  [get_ports {BC2_DATA[2]}  ]
set_property PACKAGE_PIN Y13 [get_ports {BC2_DATA[3]}  ]
set_property PACKAGE_PIN V11 [get_ports {BC2_LD[0]  }  ]
set_property PACKAGE_PIN V6  [get_ports {BC2_TRT[0] }  ]
set_property PACKAGE_PIN Y9  [get_ports {BC2_TRR[0] }  ]
##g2
...
##g4
set_property PACKAGE_PIN J16 [get_ports {BC2_SEL[3] }  ]
set_property PACKAGE_PIN K18 [get_ports {BC2_CLK[3] }  ]
set_property PACKAGE_PIN H15 [get_ports {BC2_DATA[12]} ]
set_property PACKAGE_PIN H20 [get_ports {BC2_DATA[13]} ]
set_property PACKAGE_PIN G15 [get_ports {BC2_DATA[14]} ]
set_property PACKAGE_PIN J20 [get_ports {BC2_DATA[15]} ]
set_property PACKAGE_PIN N15 [get_ports {BC2_LD[3]  }  ]
set_property PACKAGE_PIN K17 [get_ports {BC2_TRT[3] }  ]
set_property PACKAGE_PIN N16 [get_ports {BC2_TRR[3] }  ]
