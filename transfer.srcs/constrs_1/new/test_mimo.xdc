...
set_property PACKAGE_PIN E19 [get_ports {BC1_TRT[0]}]
set_property PACKAGE_PIN F19 [get_ports {BC1_TRR[0]}]
##g2
...
##bak
set_property PACKAGE_PIN D19 [get_ports {sd_back[0]}]
set_property PACKAGE_PIN V15 [get_ports {sd_back[1]}]
set_property PACKAGE_PIN G19 [get_ports {sd_back[2]}]
set_property PACKAGE_PIN Y16 [get_ports {sd_back[3]}]
set_property PACKAGE_PIN K16 [get_ports {sd_back[4]}]
set_property PACKAGE_PIN W16 [get_ports {sd_back[5]}]
set_property PACKAGE_PIN P16 [get_ports {sd_back[6]}]
set_property PACKAGE_PIN V10 [get_ports {sd_back[7]}]
...
set_property SLEW SLOW [get_ports {BC1_LD[3]}]
set_property SLEW SLOW [get_ports {BC1_LD[2]}]
set_property SLEW SLOW [get_ports {BC1_LD[1]}]
set_property SLEW SLOW [get_ports {BC1_LD[0]}]
set_property SLEW SLOW [get_ports {BC2_LD[3]}]
set_property SLEW SLOW [get_ports {BC2_LD[2]}]
set_property SLEW SLOW [get_ports {BC2_LD[1]}]
set_property SLEW SLOW [get_ports {BC2_LD[0]}]
...
set_property DRIVE 24 [get_ports BC*]